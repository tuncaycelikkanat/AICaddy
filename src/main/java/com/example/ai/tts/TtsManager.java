...
public class TtsManager {
	...
	private static void playSentenceMp3(String sentence) {
		try {
			...
			String urlStr = "https://translate.google.com/translate_tts?ie=UTF-8&client=tw-ob&tl=tr&q=" + encoded;
			...
			if (conn.getResponseCode() == 200) {
				...
				ExampleMod.LOGGER.warn("TTS HTTP error code: " + conn.getResponseCode());
			}
		} catch (Exception e) {
