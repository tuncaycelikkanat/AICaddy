...
import com.example.ai.resilience.CannedFallbackProvider;
import com.example.ai.resilience.CircuitBreaker;
	...
	public static void main(String[] args) {
		...
		for (String mood : moods) {
			for (int i = 0; i < 5; i++) {
				...
				totalTested++;
				boolean hasForeign = com.example.ai.provider.GroqAiProvider.containsForeignOrHallucinatedWords(fallback);
